...
export const TRAVERSED_TILE_STYLE = TILE_STYLE + " bg-cyan-500 cursor-pointer";
export const START_TILE_STYLE = TILE_STYLE + " bg-green-500 cursor-pointer";
export const END_TILE_STYLE = TILE_STYLE + " bg-red-600 ";
export const WALL_TILE_STYLE = TILE_STYLE + " bg-slate-800";
