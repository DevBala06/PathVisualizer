...
export function Nav({
  ...
  return (
    <div className="flex items-center lg:justify-between justify-center w-full sm:w-fit">
        <div className="flex items-center justify-center min-h-[4.5rem]  bg-neutral-600 shadow-gray-600 sm:px-5 px-0">
        {/* <h1 className="lg:flex hidden w-[40%] text-2xl pl-1">
          Pathfinding Visualizer
        </h1> */}
        <div className="flex  sm:items-center items-center justify-start sm:justify-between   flex-col sm:space-y-0 space-y-3 sm:py-0 py-4 sm:space-x-4">
          <Select
            label="Maze"
            value={maze}
            options={MAZES}
